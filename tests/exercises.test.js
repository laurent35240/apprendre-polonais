...
describe("résolubilité du corpus", () => {
  // Le test à plus forte valeur : pour CHACUN des 245 exercices build du jeu,
  ...
  it("les 245 exercices build/dialogue sont tous résolubles", () => {
    const cas = [
